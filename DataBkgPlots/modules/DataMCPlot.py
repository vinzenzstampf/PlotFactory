...
#        self.legendPos = 'left'
    ...
    def makeRootDataFrameFromTree(self, file_name, tree_name='tree', verbose=False, friend_name=None, friend_file_name=None):
        '''Cache files/trees'''
        ...
        if friend_file_name: 
            if not friend_name: friend_name = 'ML'
            ttree.AddFriend('%s = tree'%friend_name, friend_file_name)
